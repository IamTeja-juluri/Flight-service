...
async function destroyAirport(id){
    try{
        ...
        throw new AppError('Cannot delete an airport',StatusCodes.INTERNAL_SERVER_ERROR);
    }
}
...
async function updateAirport(id,data){
    try{
        ...
        throw new AppError('Cannot update an airport',StatusCodes.INTERNAL_SERVER_ERROR);
    }
}


module.exports={
    createAirport,getAirport,getAirports,updateAirport,destroyAirport
}