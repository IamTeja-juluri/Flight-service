...
async function destroyAirplane(id){
    try{
        ...
        throw new AppError('Cannot delete an airplane',StatusCodes.INTERNAL_SERVER_ERROR);
    }
}
...
async function updateAirplane(id,data){
    try{
        ...
        throw new AppError('Cannot update an airplane',StatusCodes.INTERNAL_SERVER_ERROR);
    }
}
